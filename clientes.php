<?php
	...
	$active_usuarios="";
	$active_tarifarios="";
	$title="Clientes | Facturación CIMEK";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
	...
	<div class="panel panel-info">
		...
		<form name="importa" method="post" action="<?php echo $_SERVER['PHP_SELF'] ; ?>" enctype="multipart/form-data" >
			...
			<a href="plantillas/PLANTILLA DESTINATARIO FINAL.xlsx" download="PLANTILLA DESTINATARIO FINAL" style="padding-right: 15px;padding-left: 5px;">
			Descargar Plantilla
			...
			<span class="btn btn-default btn-submit" style="background: #99CC00;"> Importar <input type="submit" class="btn btn-info" name="enviar" value="Importar" /></span>
    ...
    if ($action == "upload") {
        ...
        foreach ($_DATOS_EXCEL as $campo => $valor) {
            $sql = "insert into t_clientes values ('";
