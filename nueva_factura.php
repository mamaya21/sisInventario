				...
				<div class="form-group row">
				 ...
				 <div class="form-group row">
					<label for="importe_fac" class="col-md-1 control-label">Importe</label>
						<div class="col-md-3">
				  			<input type="text" class="form-control input-sm" id="importe_fac" name="importe_fac" placeholder="Ingresar Importe (Sub-Total) s/" required>
						</div>
				 ...
				 <div class="form-group row">
				  ...
				  <label for="tel2" class="col-md-1 control-label">RUC</label>
					...
					<label for="mail2" class="col-md-1 control-label">Teléfono</label>
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="tel2" name="tel2" placeholder="Teléfono" readonly>
							</div>
