<?php
	...
	if (empty($_POST['nombre'])) {
		...
		$sql="INSERT INTO t_clientes (nombre_cliente, RUC, Direccion, Telefono, Raz_Social, Contacto, Correo, Estado, fecha_ingreso, id_distrito)
		 VALUES ('$nombre','$ruc','$direccion','$telefono','$razsocial','$contacto','$email',$estado,GETDATE(),$distrito)";
