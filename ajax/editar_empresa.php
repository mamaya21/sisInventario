<?php
	...
	if (empty($_POST['mod_idempresa'])) {
		...
		$id_empresa=intval($_POST['mod_idempresa']);
		$sql="UPDATE t_subcontratadas SET nombre_empresa='".$nombre."', ruc='".$ruc."', telefono='".$telefono."', raz_social='".$razsocial."', contacto='".$contacto."', correo='".$email."', direccion='".$direccion."', estado=".$estado." WHERE id_empresa='".$id_empresa."'";
