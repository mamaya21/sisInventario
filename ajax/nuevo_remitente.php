<?php
	...
	if (empty($_POST['nombre'])) {
		...
		$sql="INSERT INTO t_remitentes VALUES ('$nombre','$ruc','$direccion','$telefono','$razsocial','$contacto','$email',$estado,GETDATE(),'$direccion_a')";
		$query_new_insert = odbc_exec($con,$sql);
			if ($query_new_insert){
				$messages[] = "Remitente ha sido ingresado satisfactoriamente.";
			} else{
