<?php
	...
	if (isset($_GET['id'])){
		...
		if ($estado=="1"){
			...
			$sql_i1="insert into t_facturas values('$n_fac_real',CONVERT(datetime,'$fecha_factura',101),$id_cliente,$importe,$igv,$total,'$factura_buscar','N',1); ";
			...
			while ($row_deta=odbc_fetch_array($sql_deta)) {
				...
				$sql_i2=" insert into detalle_factura values('$n_fac_real','$id_guia','$factura_det',$cantidad,$peso,0.00); ";
