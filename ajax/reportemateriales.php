...
if ($resultado->num_rows > 0) {
    ...
    $sheet->getStyle('A3:F3')->applyFromArray($estiloTituloColumnas);

    $sheet->getStyle("A4:F" . ($i - 1))->applyFromArray([
    ...
    header('Content-Disposition: attachment;filename="Reporte de Materiales.xlsx"');
