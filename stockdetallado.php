...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			...
			<div class="btn-group pull-right" style="padding-left:5px;">
					<a  href="stock.php" class="btn btn-info"><span class="glyphicon glyphicon-list-alt" ></span> Stock acumulado </a>
			</div>

			<h4><i class='glyphicon glyphicon-search'></i> Stock Detallado - Buscar por Material</h4>
		</div>
	...
	<script type="text/javascript" src="js/stockdetallado.js"></script>
