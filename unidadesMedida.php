...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevaUnidad"><span class="glyphicon glyphicon-plus" ></span> Nueva Unidad</button>
			</div>
			
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Unidades de Medida</h4>
		</div>
		<div class="panel-body">

			<?php
				include("modal/nuevo_unidadMedida.php");
				include("modal/editar_unidadMedida.php");
			?>
			<form class="form-horizontal" role="form" id="datos_cotizacion">

						<div class="form-group row">
							<label for="q" class="col-md-2 control-label">Unidad de medida</label>
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Nombre o código de la unidad de medida" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
	...
	<script type="text/javascript" src="js/unidadesMedida.js"></script>
  </body>
</html>
