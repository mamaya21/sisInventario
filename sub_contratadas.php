<?php
	...
	$active_clientes="";
	$active_remitentes="";
	$active_subcontrata="active";
	$active_transportes="";
	$active_usuarios="";
	$active_tarifarios="";
	$title="Sub-Contratadas | Facturación CIMEK";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevaEmpresa"><span class="glyphicon glyphicon-plus" ></span> Nueva Empresa</button>
			</div>
		...
		<div class="panel-body">
			...
			<?php
				include("modal/registro_subcontratadas.php");
				include("modal/editar_subcontratadas.php");
			?>
			<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Nombre de la Empresa Sub-Contratada" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
		...
		<form name="importa" method="post" action="<?php echo $_SERVER['PHP_SELF'] ; ?>" enctype="multipart/form-data" >
			...
			<a href="plantillas/PLANTILLA SUB CONTRATADAS.xlsx" download="PLANTILLA SUB CONTRATADAS" style="padding-right: 15px;padding-left: 5px;">
			Descargar Plantilla
			...
			<span class="btn btn-default btn-submit" style="background: #BEBEBE;"> Importar <input type="submit" class="btn btn-info" name="enviar" value="Importar" /></span>
    ...
    if ($action == "upload") {
        ...
        foreach ($_DATOS_EXCEL as $campo => $valor) {
            $sql = "insert into t_subcontratadas values ('";
	...
	<script type="text/javascript" src="js/sub_contratadas.js"></script>
  </body>
</html>
