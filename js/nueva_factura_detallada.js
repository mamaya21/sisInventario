		...
		function load(page){
			...
			$.ajax({
				url:'./ajax/productos_factura_detallada.php?id_remitente='+id_remitente+'&action=ajax&page='+page+'&q='+q,
	...
	function agregar (id)
		{
			...
			var imp=document.getElementById('imp_'+id).value;
			$.ajax({
        type: "POST",
        url: "./ajax/agregar_facturacion_deta.php",
        data: "id="+id+"&guia="+guia+"&cantidad="+cantidad+"&peso="+peso+"&nguia="+nguia+"&imp="+imp,
		 beforeSend: function(objeto){
		...
		$( "#datos_factura" ).submit(function( event ) {
		  ...
		  var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "ajax/nueva_factura_deta.php",
					data: parametros,
					 beforeSend: function(objeto){
					 	$("#resultados").html("Mensaje: Cargando...");
