		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'./ajax/buscar_facturas.php?action=ajax&page='+page+'&q='+q+'&desde='+desde+'&hasta='+hasta,
		...
		function imprimir_reporte(desde,hasta,q){
			VentanaCentrada('./pdf/documentos/ver_rep_facturas.php?desde='+desde+'&hasta='+hasta+'&q='+q,'Reporte','','1024','768','true');
		}
		...
		$.ajax({
        type: "GET",
        url: "./ajax/replicar_facturas.php",
        data: "id="+id,"q":q,
		 beforeSend: function(objeto){
			$("#resultados").html("Mensaje: Cargando...");
		  },
