		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'./ajax/buscar_facturas_almacenaje.php?action=ajax&page='+page+'&q='+q+'&desde='+desde+'&hasta='+hasta,
		...
		$.ajax({
        type: "GET",
        url: "./ajax/buscar_facturas_almacenaje.php",
        data: "id="+id,"q":q,
		 beforeSend: function(objeto){
		...
		function replicar(id)
		{
			...
			$.ajax({
	        type: "GET",
	        url: "./ajax/replicar_facturas_almacenaje.php",
	        data: "id="+id,"q":q,
			 beforeSend: function(objeto){
				$("#resultados").html("Mensaje: Cargando...");
			  },
		...
		function anular(id)
		{
			...
			$.ajax({
	        type: "GET",
	        url: "./ajax/anular_fac_almacenaje.php",
	        data: "id="+id,"q":q,
			 beforeSend: function(objeto){
				$("#resultados").html("Mensaje: Cargando...");
			  },
