   ...
   <table cellspacing="11" style="width: 100%;">
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt; border:1px;border-color: #FFFFFF;">
        ...
        <tr  style="border:1px; border-color: #FFFFFF;">
            ...
            <td style="widtd: 64%; text-align: center;border:1px;border-color: #FFFFFF;">SERVICIO DE ALMACENAJE</td>
            <td style="widtd: 14%; text-align: center;border:1px;border-color: #FFFFFF;"></td>
            <td style="widtd: 14%; text-align: left;border:1px;border-color: #FFFFFF;"></td>
        </tr>

<?php
$nums=1;
$sumador_total=0;
$sql=odbc_exec($con, "select factura_det as detalle, monto_det as monto  
    from detalle_fac_almacenaje 
...
while ($row=odbc_fetch_array($sql))
	...
	?>
        ...
        <tr  style="border:1px;border-color: #FFFFFF;">
            ...
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: left;border:1px;border-color: #FFFFFF;"><?php echo $monto_g;?></td>
