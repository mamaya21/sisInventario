...
<page backtop="10mm" backbottom="10mm" backleft="15mm" backright="12mm" style="font-size: 12pt; font-family: arial" >
...
$nums=1;
$sumador_total=0;
$sql=odbc_exec($con, "select factura_det as detalle, monto_guia as monto  
...
while ($row=odbc_fetch_array($sql))
	...
	?>
        ...
        <tr  style="border:1px;border-color: #FFFFFF;">
            <!--<td class='<?php echo $clase;?>' style="width: 8%; text-align: center;border:1px;border-color: #FFFFFF;"><?php echo $sumador_total;?></td>-->
            <td class='<?php echo $clase;?>' style="width: 8%; text-align: center;border:1px;border-color: #FFFFFF;"><?php echo $sumador_total;?></td>
            <td class='<?php echo $clase;?>' style="width: 64%; text-align: center;border:1px;border-color: #FFFFFF;"><?php echo $descripcion;?></td>
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: center;border:1px;border-color: #FFFFFF;"></td>
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: center;border:1px;border-color: #FFFFFF;"><?php echo $monto_g;?></td>
    ...
    <tr  style="border:1px;border-color: #FFFFFF;">
	  ...
	  <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt; ">
		<tr>
            ...
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: center;border-right: 1px;border-left: 1px;border-bottom: 1px;border-color: #FFFFFF;"><?php echo $importe; ?></td>
        </tr>
        <tr>
            <td class='<?php echo $clase;?>' style="width: 8%; text-align: center;"></td>
            <td class='<?php echo $clase;?>' style="width: 64%; text-align: center;"></td>
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: left;border:1px;border-color: #FFFFFF;"><b> &nbsp;&nbsp;&nbsp;</b></td>
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: center;border:1px;border-color: #FFFFFF;"><?php echo $igv; ?></td>
        </tr>
        <tr>
            <td class='<?php echo $clase;?>' style="width: 8%; text-align: center;"></td>
            <td class='<?php echo $clase;?>' style="width: 64%; text-align: center;"></td>
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: left;border:1px;border-color: #FFFFFF;"><b> &nbsp;&nbsp;&nbsp;</b></td>
            <td class='<?php echo $clase;?>' style="width: 14%; text-align: center;border:1px;border-color: #FFFFFF;"><?php echo $total; ?></td>
        </tr>
    </table>
