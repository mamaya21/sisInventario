...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<a  href="nueva_factura_almacenaje.php" class="btn btn-info"><span class="glyphicon glyphicon-plus" ></span> Nueva Factura</a>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Facturas por Almacenaje</h4>
		</div>
	...
	<script type="text/javascript" src="js/facturas_almacenaje.js"></script>
